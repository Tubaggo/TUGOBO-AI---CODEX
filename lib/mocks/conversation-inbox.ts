...
export const conversations: Conversation[] = [
  ...
  },
  {
    ...
    aiEnabled: true,
    humanHandoff: false,
    tags: ["Aile Konaklaması", "Çocuklu Aile"],
...
export const messages: Message[] = [
  ...
  },
  {
    ...
    senderUserId: null,
    messageType: "text",
    content: "Merhaba, 18 Nisan giriş 20 Nisan çıkış 2 kişi için bungalow uygun mu?",
    rawPayload: null,
    createdAt: "2026-03-10T19:00:00.000Z",
  },
  {
    ...
    senderUserId: null,
    messageType: "text",
    content: "Merhaba, bu tarihler için bungalow çok güzel duruyor. Konaklamanızı hazırlayabilmem için telefon numaranızı da paylaşır mısınız?",
    rawPayload: null,
...
export const notes: InternalNote[] = [
  {
    ...
    content: "Grup rezervasyonu. Teklife kahvaltı ve özel transfer seçeneği eklenmeli.",
  ...
  },
  {
    ...
    leadId: "lead_julia",
    authorUserId: "user_manager",
    content: "Aile paketi fiyatı ve havaalanı transfer seçeneğiyle takip yapın.",
...
export const reservations: Reservation[] = [
  {
    ...
    currency: "EUR",
    status: "pending",
    notes: "Misafir havaalanı transferi fiyatı istedi.",
